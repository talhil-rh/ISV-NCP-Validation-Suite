...
def main() -> int:
    ...
    parser.add_argument("--group-name", help="Tenant name to verify exists")
    ...
    if DEMO_MODE:
        if args.group_name:
            result["tenants"] = [{"tenant_name": args.group_name, "tenant_id": args.group_name}]
    ...
    try:
        ...
        for t in tenants:
            ...
            result["tenants"].append({"tenant_name": name, "tenant_id": uid})
